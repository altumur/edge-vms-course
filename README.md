...
- [`clustervms-go/`](./М11_ClusterVMS/clustervms-go/README.md) — the module in Go, built on [`vmsserver-go/`](./М10_ServerVMS/vmsserver-go/README.md), with the same 30 tests and the measurement against Python: 8.9 MB against 21.2 MB at idle, one static binary for the four jobs
