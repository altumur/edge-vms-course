...
**В Go то же самое, и разница ровно в одном:** там, где в Python вызов пробуется и падает в старую форму по `TypeError`, в Go это две двери, и компилятор сам выбирает:
