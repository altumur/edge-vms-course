...
Модуль закончен. Пятнадцать уроков: строка камеры, цикл сверки из М9, воркер, который держит камеру и не пишет её, два элемента GStreamer, архив с двумя деревьями, регистратор, ресурс, консоль, живое видео, детекторы — и всё это как десять процессов на коробке из М9.
