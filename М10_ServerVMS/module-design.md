...
- [`recorder-design.md`](../М9_EdgeVMS/recorder-design.md) — М9's recorder design this one supersedes, and М9 Lessons 5–9, whose tests are the contract
