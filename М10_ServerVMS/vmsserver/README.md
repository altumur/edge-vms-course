...
vmsserver/
  ...
  tests/                       56 tests, milliseconds, no GStreamer
```

```bash
python3 tests/run.py                                   # 56 tests
