...
vmsserver/
  ...
  tests/                       43 tests, milliseconds, no GStreamer
```

```bash
python3 tests/run.py                                   # 43 tests
