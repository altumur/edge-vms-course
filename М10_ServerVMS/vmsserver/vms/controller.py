...
# `vmsplatform.spec.SpecController` (see `vmsplatform/spec.py`) instantiated with the VMS's spec. This
...
# is documented in `vmsplatform/spec.py`. Which of them a given process may actually complete is decided by
