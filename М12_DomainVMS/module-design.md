...
| 15 | A Domain Cluster of One Node | `domain/term.py` — `DomainHost`, `carry_host`, `find_host`, `rehost`, `stranded` | `test_lesson15_domain_of_one.py` — 6 |
