...
- **No page.** The console is an API behind a login; the screen — list, timeline, playback, the forms — is built in М10 Lesson 7 once the archive is on the box, and the lesson says so rather than bolting М8's one-stream player onto a spool-and-Kinesis arrangement the next module removes
